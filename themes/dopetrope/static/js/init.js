...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			'1000px':	{ range: '737-1200', href: '/theme/css/style-1000px.css', containers: 960, grid: { gutters: 25 }, viewport: { width: 1024 } },
			'mobile':	{ range: '-736', href: '/theme/css/style-mobile.css', containers: '100%!', grid: { collapse: true, gutters: 20 }, viewport: { scalable: false } }
		},
		plugins: {
			layers: {
				config: {
